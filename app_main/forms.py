...
class DonationForm(forms.Form):
    ...
    email = forms.CharField(max_length=60, label='ایمیل (اختیاری)',widget=forms.EmailInput)
    ...
    message = forms.CharField(max_length=1000, label='توضیحات', widget=forms.Textarea)
    anonymize_donation = forms.BooleanField(label='ناشناس')